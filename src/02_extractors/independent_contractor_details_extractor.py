...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Extract independent contractor details from IRS 990 filings'
    )
    parser.add_argument(
        '--force-process',
        action='store_true',
    ...
    output_dir = Path("./data/extracted_irs_data/independent_contractor_details")
    output_dir.mkdir(parents=True, exist_ok=True)
    output_prefix = 'independent_contractor_details'
    ...
    DETAILS_SUBROOTS = {
        '990': 'ContractorCompensationGrp',
        '990PF': 'CompensationOfHghstPdCntrctGrp',
        '990EZ': 'CompensationOfHghstPdCntrctGrp'
    }
    ...
    DETAILS_FIELDS = {
        ...
        'StateAbbreviationCd': {
            '990': 'StateAbbreviationCd',
            '990PF': 'StateAbbreviationCd',
            '990EZ': 'StateAbbreviationCd',
        },
        'ZIPCd': {
            '990': 'ZIPCd',
            '990PF': 'ZIPCd',
        ...
        'ServicesDesc': {
            '990': 'ServicesDesc',
            '990PF': 'ServiceTypeTxt',
            '990EZ': 'ServiceTypeTxt',
        },
        'CompensationAmt': {
            '990': 'CompensationAmt',
            '990PF': 'CompensationAmt',
            '990EZ': 'CompensationAmt',
        },
    }
