...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Extract exemption and service description details from IRS 990 filings'
    )
    parser.add_argument(
        '--force-process',
        action='store_true',
    ...
    output_dir = Path("./data/extracted_irs_data/exemption_and_service_description")
    output_dir.mkdir(parents=True, exist_ok=True)
    output_prefix = 'exemption_and_service_description'
    ...
    DETAILS_FIELDS = {
        'PrimaryExemptPurposeTxt': {
            '990': 'PrimaryExemptPurposeTxt',
            '990PF': '',
            '990EZ': 'PrimaryExemptPurposeTxt'
        },
        'DescriptionProgramSrvcAccomTxt': {
            '990': 'DescriptionProgramSrvcAccomTxt',
            '990PF': '',
            '990EZ': 'DescriptionProgramSrvcAccomTxt'
        }
