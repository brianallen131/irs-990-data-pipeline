...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Extract program-related investments from IRS 990 filings'
    )
    parser.add_argument(
        '--force-process',
        action='store_true',
    ...
    output_dir = Path("./data/extracted_irs_data/program_related_investments")
    output_dir.mkdir(parents=True, exist_ok=True)
    output_prefix = 'program_related_investments'
    ...
    DETAILS_SUBROOTS = {
        '990': '',
        '990PF': 'SumOfProgramRelatedInvstGrp',
        '990EZ': ''
    }
    ...
    DETAILS_FIELDS = {
        ...
        'AllOtherProgramRelatedInvestmentsSchedule': {
            '990': '',
            '990PF': 'AllOtherProgramRelatedInvestmentsSchedule',
            '990EZ': ''
        },
        'AllOtherProgramRltdInvstTotAmt': {
            '990': '',
            '990PF': 'AllOtherProgramRltdInvstTotAmt',
            '990EZ': ''
        },
        'TotalAmt': {
            '990': '',
