...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Extract grant details from IRS 990 filings'
    )
    parser.add_argument(
        '--force-process',
        action='store_true',
    ...
    output_dir = Path("./data/extracted_irs_data/grant_details")
    output_dir.mkdir(parents=True, exist_ok=True)
    output_prefix = 'grant_details'
    ...
    DETAILS_FIELDS = {
        ...
        'BusinessNameLine2Txt': {
            '990': 'BusinessNameLine2Txt',
            '990PF': 'BusinessNameLine2Txt',
            '990EZ': 'BusinessNameLine2Txt'
        },
        'RecipientPersonNm': {
            '990': 'RecipientPersonNm',
            '990PF': 'RecipientPersonNm',
            '990EZ': 'RecipientPersonNm'
        },
        'RecipientEIN': {
            '990': 'RecipientEIN',
            '990PF': '',
        ...
        'GrantOrContributionPurposeTxt': {
            '990': 'PurposeOfGrantTxt',
            '990PF': 'GrantOrContributionPurposeTxt',
            '990EZ': 'PurposeOfGrantTxt'
        },
        'CashGrantAmt': {
            '990': 'CashGrantAmt',
            '990PF': 'Amt',
